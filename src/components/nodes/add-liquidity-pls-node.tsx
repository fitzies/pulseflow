...
interface AddLiquidityPLSNodeData {
  onAddNode?: () => void;
  onNodeClick?: () => void;
  isLastNode?: boolean;
...
export const AddLiquidityPLSNode = memo(({ data }: NodeProps) => {
  const nodeData = data as AddLiquidityPLSNodeData;
    ...
    <div className={NODE_WRAPPER_CLASS}>
      ...
      {nodeData?.showNodeLabels !== false && (
        <div className={NODE_LABEL_CONTAINER_WIDE_CLASS}>
          <span className={NODE_TITLE_CLASS}>Add Liquidity PLS</span>
...
AddLiquidityPLSNode.displayName = 'AddLiquidityPLSNode';
