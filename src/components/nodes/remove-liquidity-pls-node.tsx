...
export const RemoveLiquidityPLSNode = memo(({ data }: NodeProps) => {
  const nodeData = data as RemoveLiquidityPLSNodeData;
    ...
    <div className={NODE_WRAPPER_CLASS}>
      ...
      {nodeData?.showNodeLabels !== false && (
        <div className={NODE_LABEL_CONTAINER_WIDE_CLASS}>
          <span className={NODE_TITLE_CLASS}>Remove Liquidity PLS</span>
...
RemoveLiquidityPLSNode.displayName = 'RemoveLiquidityPLSNode';
